...
HTML::Puzzle - A framework to build web component based on database. (ver 0.03)
...
=item * CPAN DBI module.

=item * A CPAN DBD driver module (currenty only Mysql are tested)
...
HTML::Puzzle -  A framework to built web component based on database. with Perl 
